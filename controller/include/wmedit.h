...
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_TEXT_ESCAPE,-1)
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_TEXT_TAB,-1)
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_TEXT_BACKSPACE,-1)

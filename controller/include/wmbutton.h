...
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_BUTTON_PRESSED,-1)
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_BUTTON_RELEASED,-1)
DECLARE_EXPORTED_EVENT_TYPE(WXEXPORT, wxEVT_BUTTON_HELD,-1)

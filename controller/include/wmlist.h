...
wxDECLARE_EXPORTED_EVENT(WXEXPORT, wxEVT_LIST_SELECTED, wxCommandEvent);
wxDECLARE_EXPORTED_EVENT(WXEXPORT, wxEVT_LIST_HELD, wxCommandEvent);
wxDECLARE_EXPORTED_EVENT(WXEXPORT, wxEVT_LIST_PAGED, wxCommandEvent);
wxDECLARE_EXPORTED_EVENT(WXEXPORT, wxEVT_LIST_SLID, wxCommandEvent);

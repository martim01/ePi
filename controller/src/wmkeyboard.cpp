...
wxIMPLEMENT_DYNAMIC_CLASS(wmKeyboard, wxWindow);
...
wmKeyboard::wmKeyboard(wxWindow* pParent, wxWindowID id, const wxPoint& pos, const wxSize& size, unsigned int nStyle, bool bHints) : wxWindow()
{

#ifndef DLGFILEMANAGER_H
#define DLGFILEMANAGER_H
...
class dlgFileManager: public wxDialog
{
	public:

		dlgFileManager(wxWindow* parent,WebSocketClient& wsClient, const wxString& sHostname, const wxString& sIpAddress, const wxString& sUrl, const std::string& sUid, wxWindowID id=wxID_ANY,const wxPoint& pos=wxDefaultPosition,const wxSize& size=wxDefaultSize);
		virtual ~dlgFileManager();
